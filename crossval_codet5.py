# main with 5-fold cross-validation and reporting using CodeT5
print("import 1")
import pandas as pd
import numpy as np
import torch
...
log_path = "output_log_crossval_codet5.txt"
run_timestamp = datetime.now().strftime("%d/%m/%Y %H:%M")
with open(log_path, "w", encoding="utf-8") as f:
    f.write(f"CodeT5 {SPLIT}-Fold Cross-Validation Results\n")
