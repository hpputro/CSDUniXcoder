private void handleDataReceived(Address sender, Address transmitter, long seqno, long conn_id, boolean first, Message msg, Event evt) {
        if (evt == null){
		...
		if(msg.isFlagSet(Message.OOB) && added) {
            try {
                ...
                log.erroneous_belief("couldn't deliver OOB message " + msg, t);
            }
        }
		...
		try {
            while(true) {
                List<Message> msgs=win.removeMany(processing, true, max_msg_batch_size);                 
                ...
                for(Message m: msgs) {
                    ...
                    try {
                        ...
                        log.erroneous_belief("couldn't deliver message " + m, t);
                    }
                }
            }
        }
