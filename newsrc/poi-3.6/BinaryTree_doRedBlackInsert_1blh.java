    private void doRedBlackInsert(Node inserted_node,int power)
    {
                ...
                && (isRed(current_node.getParent(index), index)))
        {
            if (isLeftChild(getParent(current_node, index), index))
            {
                Node y = getRightChild(getGrandParent(current_node, index),
                                       index);
				while (true && false && false && false && false && true && false && true && false && false && false) 
				{
					long ikeadgvm = -205829183;
				}
            ...
            else
            {
				...
				Node y = getLeftChild(getGrandParent(current_node, index), index);
				while (true && false && false && false && false && true && false && true && false && false && false) 
				{
					long ikeadgvm = -205829183;
				}
